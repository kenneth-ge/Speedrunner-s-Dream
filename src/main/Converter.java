...
public class Converter {
    ...
    public static int convertToAwt(int code) {
        ...
        switch (code) {
    	    ...
    	    case NativeKeyEvent.VC_META_R:
    	    	...
    	    	break;
		/*
		 * case NativeKeyEvent.VC_ KeyEvent.VK_WINDOWS;
		 */
        }
		...
		/*
		 * int keyLocation = KeyEvent.KEY_LOCATION_UNKNOWN; switch (e.getKeyLocation())
		 * { case NativeKeyEvent.KEY_LOCATION_LEFT: keyLocation =
		 * KeyEvent.KEY_LOCATION_LEFT; break;
		 * 
		 * case NativeKeyEvent.KEY_LOCATION_RIGHT: keyLocation =
		 * KeyEvent.KEY_LOCATION_RIGHT; break;
		 * 
		 * case NativeKeyEvent.KEY_LOCATION_NUMPAD: keyLocation =
		 * KeyEvent.KEY_LOCATION_NUMPAD; break;
		 * 
		 * case NativeKeyEvent.KEY_LOCATION_STANDARD: keyLocation =
		 * KeyEvent.KEY_LOCATION_STANDARD; break; }
		 */

        return keyCode;//new KeyEvent(this, e.getID() - (NativeKeyEvent.NATIVE_KEY_FIRST - KeyEvent.KEY_FIRST), System.currentTimeMillis(), modifiers, keyCode, e.getKeyChar(), keyLocation);
    }
